# Script for predicting fixed changepoints with l1trendfiltering on simulated signals
...
main <- function(args) {
  ...
  # Predict pipeline
  total_variance = 3 * power(estimated_std_dev,2)
  penBIC = vartotal * np.log(len(signal)) * 3000
